...
- **Site** — the Astro site reads the same canonical layout for both engines; the studio Publish step surfaces the book's engine + exact rendered-credit spend.
