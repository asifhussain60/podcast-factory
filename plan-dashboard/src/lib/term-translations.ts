...
const RAW: Record<string, Translation> = {
  ...
  salih: {
    english: "Saleh",
    note: "prophet to Thamud — no direct biblical name",
  },
  ...
  shuayb: {
    english: "Jethro",
    note: "father-in-law of Moses in some traditions",
  },
  musa: { english: "Moses" },
  harun: { english: "Aaron" },
  ...
  israfil: {
    english: "Raphael",
    note: "angel of the trumpet; identified with Raphael in some traditions",
  },
  ...
  iblis: {
    english: "Iblis",
    note: 'proper name of the devil — keep as is or use "Satan"',
  },
  ...
  imam: {
    english: "Imam",
    note: "context-dependent — often left untranslated",
  },
  ...
  "al-husayn": {
    english: "al-Husayn",
    note: "grandson of the Prophet — name kept in Islamic contexts",
  },
  "al-wafayat": {
    english: "Obituaries",
    note: "short title of Ibn Khallikan's biographical dictionary",
  },
