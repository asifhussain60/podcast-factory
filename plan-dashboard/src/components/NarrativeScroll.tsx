...
function VisualReadBook() {
  return (
    <NarrativeSvg
      titleId="n-read-book-title"
      descId="n-read-book-desc"
      title="Read and scan source book"
      desc="A source document is scanned and converted into structured text."
    >
      <defs>
        <style>{`
...
function VisualPolishText() {
  return (
    <NarrativeSvg
      titleId="n-polish-title"
      descId="n-polish-desc"
      title="Polish and correct text"
      desc="Problem lines are corrected and approved into a clean version."
    >
      <defs>
        <style>{`
...
function VisualLearnNames() {
  return (
    <NarrativeSvg
      titleId="n-names-title"
      descId="n-names-desc"
      title="Learn names and terms"
      desc="Highlighted Arabic names are paired with phonetic guides."
    >
      <defs>
        <style>{`
...
function VisualPlanEpisodes() {
  return (
    <NarrativeSvg
      titleId="n-plan-title"
      descId="n-plan-desc"
      title="Plan episode structure"
      desc="Book chapters are mapped into an episode sequence with pacing."
    >
      <defs>
        <style>{`
...
function VisualEnrich() {
  return (
    <NarrativeSvg
      titleId="n-enrich-title"
      descId="n-enrich-desc"
      title="Enrich chapter draft"
      desc="Core chapter text is expanded with contextual supporting material."
    >
      <defs>
        <style>{`
...
function VisualOutsideKnowledge() {
  return (
    <NarrativeSvg
      titleId="n-knowledge-title"
      descId="n-knowledge-desc"
      title="Bring in outside knowledge"
      desc="External references and source knowledge are pulled into the pipeline."
    >
      <defs>
        <style>{`
      ...
      {[
        ...
        <g key={i} className={c.cls}>
          ...
          />
          <polyline
            points={`312,${c.y + 52} 316,${c.y + 57} 324,${c.y + 47}`}
            className={c.kls}
            fill="none"
            stroke={c.color}
            strokeWidth="2.5"
...
function VisualCutPieces() {
  return (
    <NarrativeSvg
      titleId="n-cut-title"
      descId="n-cut-desc"
      title="Cut chapter into pieces"
      desc="A larger narrative is segmented into smaller structured parts."
    >
      <defs>
        <style>{`
...
function VisualNarratorFraming() {
  return (
    <NarrativeSvg
      titleId="n-frame-title"
      descId="n-frame-desc"
      title="Add narrator framing"
      desc="A narrator layer wraps the content with opening and closing guidance."
    >
      <defs>
        <style>{`
      ...
      />
      <path
        d="M 73 218 Q 73 232 84 232 Q 95 232 95 218"
        fill="none"
        stroke="#c9973a"
        strokeWidth="2.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M 267 218 Q 267 232 278 232 Q 289 232 289 218"
        fill="none"
        stroke="#5aabf0"
        strokeWidth="2.5"
        strokeLinecap="round"
...
function VisualSlides() {
  return (
    <NarrativeSvg
      titleId="n-slides-title"
      descId="n-slides-desc"
      title="Prepare slide deck"
      desc="Chapter material is transformed into a visual slide sequence."
    >
      <defs>
        <style>{`
...
function VisualAudit() {
  return (
    <NarrativeSvg
      titleId="n-audit-title"
      descId="n-audit-desc"
      title="Audit the final package"
      desc="Quality checks loop until the chapter package passes."
    >
      <defs>
        <style>{`
      ...
      {[
        ...
        <g key={i}>
          ...
          />
          <polyline
            points={`183,${item.y + 17} 188,${item.y + 22} 197,${item.y + 11}`}
            className={item.ck}
            fill="none"
            stroke="#5ac87a"
            strokeWidth="2.5"
      ...
      <path
        d="M 272 34 A 56 56 0 1 0 271 42"
        className="au-loop"
        fill="none"
        stroke="#c9973a"
        strokeWidth="3"
...
function VisualShip() {
  return (
    <NarrativeSvg
      titleId="n-ship-title"
      descId="n-ship-desc"
      title="Ship the finished episode"
      desc="Draft materials move into a finished packaged podcast release."
    >
      <defs>
        <style>{`
      ...
      <g className="sh-seal">
        ...
        <text x="285" y="68" textAnchor="middle" fill="#ffd700" fontSize="13">
          ✦
        </text>
      </g>
    </NarrativeSvg>
...
const PHASE_NARRATIVE: Record<string, { headline: string; body: string }> = {
  ...
  P5: {
    headline:
      "The factory reads the wider field so the episode doesn't have to.",
  ...
  useEffect(() => {
    ...
    if (!isMobile) {
      ...
      chapters.forEach((chapter, index) => {
        const station = chapter.querySelector<HTMLElement>(
          ".narrative-chapter-station",
        );
    ...
    outroTl
      ...
      .to(
        ".narrative-outro-actions",
        { opacity: 1, y: 0, duration: 0.5, ease: "power2.out" },
        "-=0.2",
      )
      .to(
        ".narrative-quality-row",
        { opacity: 1, y: 0, duration: 0.6, ease: "power2.out" },
        "-=0.1",
      );
    ScrollTrigger.create({
      trigger: ".narrative-outro",
      start: "top 70%",
      animation: outroTl,
    ...
    <div ref={rootRef} className="narrative-root">
      ...
      <section className="narrative-hero">
        ...
        <div className="narrative-hero-logo">
          <div className="logo-placeholder-ring">
            <svg
              className="logo-placeholder-inner-svg"
              viewBox="0 0 120 120"
              xmlns="http://www.w3.org/2000/svg"
              role="img"
              aria-labelledby="logo-placeholder-title logo-placeholder-desc"
            >
              <title id="logo-placeholder-title">
                Podcast factory logo placeholder
              </title>
              <desc id="logo-placeholder-desc">
                A stylized factory outline with smokestacks and sound waves.
              </desc>
              {/* Factory silhouette */}
              <rect
                x="20"
              ...
              />
              <circle cx="52" cy="107" r="3" fill="rgba(201,151,58,0.25)" />
              <rect
                x="64"
                y="104"
                width="10"
        ...
        <p className="narrative-hero-lede">
          ...
          data, recordings — goes in. A beautifully produced, verified podcast
          series comes out.
        </p>
        ...
        <div className="narrative-hero-cta">
          <a href="/studio" className="narrative-cta-primary">
            Browse the catalog →
          </a>
          <a href="#station-1" className="narrative-cta-secondary">
            Tour the factory ↓
          </a>
        </div>
      ...
      <div className="narrative-chapters-wrapper" id="station-1">
        {phases.map((phase, index) => {
          ...
          return (
            <section
              key={phase.id}
              className={`narrative-chapter${index % 2 === 1 ? " narrative-chapter--reversed" : ""}`}
            >
                ...
                <div className="narrative-chapter-text">
                  <div className="narrative-chapter-station">
                    ...
                    <div className="n-station-meta">
                      ...
                      <span className="n-station-duration">
                        {phase.duration_minutes} min avg
                      </span>
                    </div>
                  </div>
                ...
                <div className="narrative-chapter-visual">
                  <div className="n-visual-frame">
                    ...
                    {PHASE_IMAGES[phase.id] ? (
                      <img
                        src={PHASE_IMAGES[phase.id]}
                        alt=""
                        className="n-visual-img"
                      />
                    ) : VisualComponent ? (
                      <VisualComponent />
                    ) : null}
      ...
      <section className="narrative-outro">
        ...
        <h2 className="narrative-outro-title">
          From raw source material to a catalog entry.
          <br />
          In one automated run.
        </h2>
        <p className="narrative-outro-sub">
          Every series that leaves this factory has been read, structured,
          enriched, authored, visualized, and reviewed. The audience hears the
          finished work. They never see the factory.
        </p>
        <div className="narrative-outro-actions">
          <a href="/studio" className="narrative-cta-primary">
            Open the catalog →
          </a>
          <a href="/architecture" className="narrative-cta-secondary">
            Architecture detail ↗
          </a>
        </div>
        ...
        <div className="narrative-quality-row">
          ...
          <div className="n-quality-item">
            ...
            <span className="n-quality-label">
  ...
  return (
    <div className="narrative-hero-particles" aria-hidden="true">
      {particles.map((symbol, i) => (
        <span key={i} className="n-particle">
          {symbol}
        </span>
      ))}
    </div>
