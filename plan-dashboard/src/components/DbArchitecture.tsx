...
const TABLES: TableNode[] = [
  ...
  },
  {
    ...
    x: 240, y: 12,
    fields: [
      { name: 'id',             type: 'TEXT',    pk: true,               description: "Canonical identifier: 'quran:2:255' | 'hadith:bukhari:1234' | 'doctrine:wisdom:24:650:0'." },
      ...
      { name: 'first_seen_book',    type: 'TEXT', fk: 'books.slug', nullable: true, description: 'First pipeline book to surface this atom. Null for corpus-only atoms (sourced exclusively from the Wisdom corpus or other external corpora).' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'source_type',       type: 'TEXT',                                         description: "'pipeline' — atom extracted from an orchestrated book chapter | 'corpus' — atom extracted from an external corpus (Wisdom corpus or future corpora). Discriminates which FK below is set." },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'topic_type_id', type: 'INTEGER', fk: 'topic_type_taxonomy.type_id', nullable: true, description: 'FK back to the taxonomy row that sourced this tag. Null for tags added outside the Wisdom taxonomy (e.g. manual pipeline tags).' },
      { name: 'created_at',    type: 'TEXT',                                               description: 'ISO-8601.' },
    ],
  },
  {
    ...
    fields: [
      { name: 'id',               type: 'INTEGER', pk: true,               description: 'Auto-increment.' },
      { name: 'corpus_key',       type: 'TEXT',                             description: "Short stable identifier, e.g. 'wisdom'. Used across scripts and logs." },
      { name: 'title_en',         type: 'TEXT',                             description: 'Full English title, e.g. Wisdom Corpus of Sheikh Bahai.' },
  ...
  },
  {
    ...
    x: 240, y: 180,
    fields: [
      { name: 'type_id',             type: 'INTEGER', pk: true,             description: 'Matches the TopicTypeID from the Wisdom DB (15, 17, 18 … 34).' },
  ...
  },
  {
    ...
    fields: [
      { name: 'id',                  type: 'INTEGER', pk: true,                    description: 'Auto-increment.' },
      { name: 'corpus_id',           type: 'INTEGER', fk: 'external_corpora.id',   description: 'Parent corpus (e.g. Wisdom corpus).' },
      { name: 'chapter_slug',        type: 'TEXT',                                 description: "Stable slug matching the directory under wisdom-ksessions/extracted/, e.g. '01-spiritual-wisdom/03-hadiths'." },
      ...
      { name: 'adapted_path',        type: 'TEXT',    nullable: true,              description: 'Relative path to adapted-extract.en.md under wisdom-ksessions/. Null if not yet extracted.' },
