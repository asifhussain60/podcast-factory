  ...
  return (
    <div className="bundle-wrap">
      <div className="bundle-controls">
        ...
        >
          {status === 'loading'
            ? <><span className="bundle-spinner" aria-hidden="true" />Generating…</>
      ...
      {status === 'ready' && bundle && (
        <div className="bundle-output">
          <p className="bundle-nlm-note">
            In NotebookLM → Audio Overview → Customize →
            format: <strong>{format === 'deep-dive' ? 'Deep dive' : 'Debate'}</strong> ·
          ...
          <div className="bundle-panels">
            <div className="bundle-panel">
              <div className="bundle-panel-head">
                <span className="bundle-panel-label">Source — upload to NotebookLM</span>
                <button
            ...
            <div className="bundle-panel">
              <div className="bundle-panel-head">
                <span className="bundle-panel-label">Framing — paste into Customize</span>
                <button
