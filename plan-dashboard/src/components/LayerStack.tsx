  ...
  return (
    ...
    >
      ...
      <desc id="layer-stack-desc">
        A stacked diagram showing the six system layers from the bottom up.
      </desc>
      <defs>
        <marker
          id="arrow-up"
          ...
          return (
            <g key={l.id}>
              <rect
                ...
                rx={8}
              />
              <text x={40} y={y + 22} className="t-title">
                Layer {l.id} · {l.name}
              </text>
              <text x={40} y={y + 44} className="label-sm">
                {l.plain}
              </text>
              {i < layers.length - 1 && (
                <line
