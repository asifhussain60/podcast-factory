...
export default function VendorLogo({ vendor, size = 36 }: Props) {
  ...
  switch (vendor) {
    case 'anthropic':
      return (
        <svg width={s} height={s} viewBox="0 0 48 48" aria-label="Anthropic" role="img">
    ...
    case 'google':
      return (
        <svg width={s} height={s} viewBox="0 0 48 48" aria-label="Google" role="img">
    ...
    case 'azure':
      return (
        <svg width={s} height={s} viewBox="0 0 48 48" aria-label="Microsoft Azure" role="img">
    ...
    case 'notebooklm':
      return (
        <svg width={s} height={s} viewBox="0 0 48 48" aria-label="NotebookLM" role="img">
    ...
    case 'github':
      return (
        <svg width={s} height={s} viewBox="0 0 48 48" aria-label="GitHub" role="img">
    ...
    case 'source':
      return (
        <svg width={s} height={s} viewBox="0 0 48 48" aria-label="Source PDF" role="img">
    ...
    case 'output':
      return (
        <svg width={s} height={s} viewBox="0 0 48 48" aria-label="Published podcast" role="img">
