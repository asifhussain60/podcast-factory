    ...
    case "anthropic":
      return (
        <svg
          ...
          viewBox="0 0 48 48"
          role="img"
          aria-labelledby="vendor-logo-anthropic-title vendor-logo-anthropic-desc"
        >
          ...
          <path
            d="M16 34 L24 14 L32 34 M19.5 26 L28.5 26"
            className="logo-mark-anthropic"
          />
        </svg>
      );
    case "google":
      return (
        <svg
          ...
          viewBox="0 0 48 48"
          role="img"
          aria-labelledby="vendor-logo-google-title vendor-logo-google-desc"
        >
          ...
          <path
            d="M30 19 A 9 9 0 1 0 33 26 L24 26"
            className="logo-mark-google"
          />
        </svg>
      );
    case "azure":
      return (
        <svg
          ...
          viewBox="0 0 48 48"
          role="img"
          aria-labelledby="vendor-logo-azure-title vendor-logo-azure-desc"
        >
    ...
    case "notebooklm":
      return (
        <svg
          ...
          viewBox="0 0 48 48"
          role="img"
          aria-labelledby="vendor-logo-notebooklm-title vendor-logo-notebooklm-desc"
        >
          ...
          <path
            d="M14 18 Q14 14 18 14 L24 14 L24 34 L18 34 Q14 34 14 30 Z"
            className="logo-mark-notebooklm"
          />
          <path
            d="M34 18 Q34 14 30 14 L24 14 L24 34 L30 34 Q34 34 34 30 Z"
            className="logo-mark-notebooklm"
          />
          <path
            d="M32 11 L33 8 L34 11 L37 12 L34 13 L33 16 L32 13 L29 12 Z"
    ...
    case "github":
      return (
        <svg
          ...
          viewBox="0 0 48 48"
          role="img"
          aria-labelledby="vendor-logo-github-title vendor-logo-github-desc"
        >
          ...
          <path
            d="M24 12 A 12 12 0 0 0 20 35 V31 Q16 32 15 28 Q14 26 12 25 Q15 25 16 28 Q18 30 21 29 V27 Q15 26 15 21 Q15 19 16 17 Q16 14 17 14 Q19 14 20 16 Q22 15 24 15 Q26 15 28 16 Q29 14 31 14 Q32 14 32 17 Q33 19 33 21 Q33 26 27 27 V30 Q27 32 28 33 V36 A 12 12 0 0 0 24 12 Z"
            className="logo-mark-github"
          />
        </svg>
      );
    case "source":
      return (
        <svg
          ...
          viewBox="0 0 48 48"
          role="img"
          aria-labelledby="vendor-logo-source-title vendor-logo-source-desc"
        >
          ...
          <path
            d="M16 12 L28 12 L34 18 L34 36 L16 36 Z"
            className="logo-mark-source"
          />
          <path d="M28 12 L28 18 L34 18" className="logo-mark-source-fold" />
          <text x="24" y="30" textAnchor="middle" className="logo-source-tag">
            PDF
          </text>
        </svg>
      );
    case "output":
      return (
        <svg
          ...
          viewBox="0 0 48 48"
          role="img"
          aria-labelledby="vendor-logo-output-title vendor-logo-output-desc"
        >
          ...
          <path
            d="M14 38 Q14 30 24 30 Q34 30 34 38"
            className="logo-mark-output-body"
          />
