...
const LEVELS: { id: string; label: string; icon: string; blurb: string }[] = [
  {
    ...
    label: "General",
    icon: "📖",
    blurb: "Biographical & historical narrative",
  },
  {
    id: "advanced",
    label: "Advanced",
    icon: "⚖️",
    blurb: "Advanced scholarly; law & formal commentary",
  },
  {
    id: "taveel",
    label: "Ta'wil",
    icon: "🔮",
    blurb: "Allegorical / esoteric interpretation (batin)",
  },
  {
    id: "mamsool",
    label: "Mamsool",
    icon: "🪬",
    blurb: "Parables & exemplars — esoteric teaching through analogy",
  },
  {
    id: "mabda_maad",
    label: "Origin & Return",
    icon: "🌌",
    blurb: "Cosmological origin & return — cosmic intellects, mabdaʿ & maʿād",
  },
  {
    id: "haqaiq",
    label: "Haqaiq",
    icon: "💎",
    blurb: "Essential realities — deepest metaphysical truths",
  },
    ...
    <div className="cl-selector">
      <div className="cl-options" role="radiogroup" aria-label="Content level">
        {LEVELS.map((lv) => (
          ...
          >
            <span className="cl-option-icon" aria-hidden="true">
              {lv.icon}
            </span>
