...
const ARABIC_SCRIPT_RUN =
  /[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF](?:[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF\s]*[\u0600-\u06FF\u0750-\u077F\u08A0-\u08FF])?/;
const ARABIC_PAIR_RE =
...
const ACTION_BY_KIND: Record<string, ActionDef> = Object.fromEntries(
...
const CONTENT_SECTION_TAGS = SECTION_TAGS.filter(
  (t) => !["delete", "improve"].includes(t.id),
);
const WORKFLOW_SECTION_TAGS = SECTION_TAGS.filter((t) =>
