...
const ACTION_INTROS: Record<string, string> = {
  research:
    "Research the following passage from the book and return a structured summary with web-sourced context:",
  improve:
    "Suggest improvements for the following passage, citing modern scholarship where applicable:",
  crossref:
    "Find cross-references, parallel passages, and related concepts for the following text:",
