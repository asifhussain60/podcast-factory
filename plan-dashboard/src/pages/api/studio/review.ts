...
import { readReview, setStageReview, setChapterFinalized } from '../../../lib/reader/stage-review';
...
export const POST: APIRoute = async ({ request }) => {
  let body: { slug?: string; chapter?: string; stage?: string; approved?: boolean; notes?: string; finalize?: boolean };
  try {
