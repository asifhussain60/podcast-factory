...
function parseKey(body: Record<string, unknown>): { slug: string; chapter: string; stage: string } | Response {
  ...
  if (!findContentDirSync(slug))      return apiError(`Book not found: ${slug}`, 404);
