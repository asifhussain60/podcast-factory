...
// The `_system/` sidecar loaders — the audit's mushaf-resolved runs, their
// citations, the visuals index and the source crosswalk — moved to
// ./book-sidecars.mjs on 2026-08-16 (DR-005). Imported AND re-exported, the
// same shape as the book-style-settings split above: buildBookHtml calls all
// four, so `export … from` alone would not bind them here.
import {
  readQuranicRuns,
  readQuranicRefs,
  readVisualAssets,
  readCrosswalk,
} from "./book-sidecars.mjs";
export { readQuranicRuns, readQuranicRefs, readVisualAssets, readCrosswalk };
/**
