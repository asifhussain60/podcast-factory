...
| Podcast book chapters (in flight) | `content/<Bucket>/<slug>/chapters/` | Named ch{NN}-{slug}.txt; uploaded to NotebookLM as SOURCE |
| Podcast book chapters (shipped) | `content/<Bucket>/<slug>/chapters/` | Same path as draft — `status` is a field in meta.yml, not a folder |
| Podcast episode prompts | `content/<Bucket>/<slug>/episodes/` | Built from 00-framing.md by build_episode_txt.py |
| Slide-deck deliverables | `content/<Bucket>/<slug>/slide-decks/` | chNN-deck-<slug>.txt + chNN-framing-<slug>.md pairs (slide-deck enhancement 2026-05-23) |
| Per-chapter Extract contracts | `content/<Bucket>/<slug>/chapter-contracts/` | YAML schema in `content/podcast/.skill/handbook/chapter-contract.template.yml` |
| Skill handbook refs (podcast) | `content/podcast/.skill/handbook/` | Book-agnostic; book-bound = `content/<Bucket>/<slug>/_system/` |
| Per-book registry | `content/<Bucket>/<slug>/_system/registry.md` | Validated by `scripts/podcast/validate_registry.py` |
