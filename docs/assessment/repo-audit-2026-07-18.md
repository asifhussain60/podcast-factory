...
|---|---|---|---|---|---|
| R1 | P1 | Pipeline | Plaintext local DB password committed (now in **two** files) | `tools/source_extractor/db.py:11`, `_pull_ksessions.py:18` = a literal `sa` password (value redacted 2026-09-04) | Accept |
