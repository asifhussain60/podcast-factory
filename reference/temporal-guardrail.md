...
A person, event, or concept MUST NOT be mentioned before their narrative introduction.
- Ishrat: Cannot appear before her introduction scene. In Ch01, first mention is now at line 99 (proper intro). Forward-reference at old lines 71/85 FIXED April 11.
- Javeed Bhai: Cannot appear before his introduction (post-9/11 / Love ch)
- Nadeem Moosa: Cannot appear before his introduction (Karachi college / Man ch)
- The cousin: Cannot appear before her introduction (childhood / Love ch)
- Ex-wife: Cannot appear before marriage section (Marriage ch)
- Saima: Cannot appear before Dianetics section (Marriage ch)

### Rule 2: CROSS-CHAPTER REFERENCES MUST BE BACKWARD-LOOKING
When referencing a person or event from another chapter, the reference must be to something ALREADY told in a previous chapter (based on the chapter order: Intro → Man → Love → Marriage → future chapters).
...
### Rule 3: INCIDENT OWNERSHIP
Each incident has a PRIMARY chapter where it is told in full as a scene. In later chapters, it can be REFERENCED briefly (1-2 sentences) but never re-told in detail.

| Incident | Primary Chapter | Can Reference In |
|---|---|---|
| Pillow/ceiling | Love | Man, Faith |
| Dirty joke | Love | — |
| Hamila/cat | Love | — |
| Locked bedroom | Love | Marriage, Faith |
| Magic kit | Love | Education |
| Therapist/red sofa | Love | Faith |
| Paint-by-number | Love | — |
| Marlboro | Love | Man |
| Caning | Love | Man |
| Bus stop | Marriage | — |
| Rooftop Karachi | Marriage | — |
| Stealing from cupboard | Man | — |
| Spirit investigation | Man | — |
| School fight | Man | — |
| Taekwondo | Man | Discipline |
| Nadeem Moosa | Man | Friendship |
| Cancer lie | Love | — |
| Engagement accusation | Marriage | Love (brief ref) |
| Cousin (love interest) | Marriage | Love (brief ref) |
| Ex-wife marriage | Marriage | Love (brief ref) |
| Ishrat meeting | Love | Marriage, all future |
| Javeed Bhai | Love (intro) | Faith (full story) |
| Islamic sessions | Love | Faith |
| Weight loss | Love | Marriage |
| Stephanie / CKO | Love | Friendship |
| Jewelry incident | Man | — |
| Afifa Khala warmth | Love | Man, Marriage |
| Annu Khala warmth | Love | Man, Marriage |
...
2. For each person/event mentioned in a chapter, verify it has been INTRODUCED before that point
3. For cross-chapter references, verify the referenced event exists in a PRIOR chapter
4. Flag any violation as: "TEMPORAL VIOLATION: [person/event] referenced at [chapter:line] before introduction at [chapter:line]"

## KNOWN CURRENT STATE (April 11, 2026)

### Ch01 (Man) — Introduced:
Baba, Amma, Atif (brother), Afifa Khala, school fight Atif, Taekwondo, stealing/cupboard, spirit, Nadeem Moosa, PPP, Ishrat (as wife, after all childhood — Ishrat forward-reference FIXED April 11: removed from lines 71/85, first mention now at proper introduction), Erum (daughter), Ali (AS)

### Ch02 (Love) — Introduced:
All childhood incidents, cousin, Javeed Bhai, Islamic sessions, Ishrat (meeting through sessions), weight loss, ABD/mercy transformation, cancer lie (sympathy hunger — MOVED from Ch01 April 11, 2026)

### Ch03 (Marriage) — Introduced:
Bus stop, rooftop Karachi, engagement/accusation, ex-wife, cousin (love interest), Ishrat (rubble meeting), dead marriage, sex education damage
