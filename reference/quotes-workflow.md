...
- In DAD'S ADVICE sections (father's voice): "Remember what Allah tells us in the Quran..." or "The Commander of the Faithful, Maulana Ali, said it plainly..." The father uses these as a man of faith would, naturally, not as a preacher.
...
[QUOTE-###]
Source: [Category A: Quran/Hadith/Maulana Ali, or Category B: author name]
Original text: [exact transcription or standard translation]
Attribution style: [Category A: respectful attribution in text / Category B: invisible weaving]
Theme tags: [select all that apply: manhood / love / marriage / faith / money / discipline / pride / friendship / silence / fear / forgiveness / patience / family / courage / generosity / humility]
Best fit: [which chapter and section]
Used in: [chapter name, or "unused"]
Notes: [how it might be adapted]

Number entries sequentially. Read the existing file first to find the next number.
...
**Voice matching (both categories):**
- In NARRATIVE sections: Asif's reflective first-person voice, matching his cadence, vocabulary, and emotional register
- In DAD'S ADVICE sections: the father's second-person voice, warm and direct
- Asif's language may be lightly adapted for grammar and tone, but the original meaning must survive intact

**How to weave Category A well:**

CRITICAL RULE: Sacred sources (Quran, hadith, Maulana Ali) must be 1-2 sentences maximum when woven into any section of the memoir. Never expand a verse into explanation. State it, ground it in one line, and move on. The memoir is not an Islamic lecture. If you find yourself writing more than two sentences around a Quranic reference, cut back immediately.

The sacred quote should arrive at a moment where it earns its weight. It should feel like Asif (or the father) is drawing on faith because the experience demanded it, not because a verse was sitting in a library waiting to be inserted.
...
Identify the core truth in the quote. Strip away the author's particular phrasing. What is the naked idea underneath?

Then ask: how would this voice (Asif's or the father's) say this same thing? The result should feel like the person arrived at this truth through experience, not reading.

Example of wrong approach:
Original: "The most important thing in communication is hearing what isn't said." (Peter Drucker)
Wrong: "As someone wise once put it, the most important thing in communication is hearing what isn't said."

Example of right approach:
"Learn to listen for the thing she did not say. The silence after a question. The answer that came a beat too fast. A woman will tell you everything you need to know, often without words."

The idea is preserved. The source is gone. The voice owns it completely.

**After using a quote**, update the quotes-library.txt entry:
Change: `Used in: unused`
To: `Used in: [chapter name] - [brief note on how it was adapted]`

## Once-Only Rule

Each quote may be used ONCE across the entire memoir. Never repeat a quote idea in a second chapter, a second section, or a second draft. Once the "Used in" field is updated, that quote is permanently retired.

Before weaving any quote, check its "Used in" field in quotes-library.txt:
- If it says "unused," proceed with weaving.
- If it names any chapter or section, skip it entirely and move to the next unused quote.

When writing or refining multiple chapters in sequence, re-read the quotes library before each chapter to ensure no quote has been claimed since the last check.
...
This memoir is a BOOK, not a journal. Chapters are read in order. Therefore:
...
Before finalizing any section that incorporates a quote idea, ask:
- Does this sentence sound like it came from this voice, in this chapter, in this context?
- For Category A: does the attribution feel earned and natural, not decorative?
- For Category B: could anyone reading it identify the source, even roughly?
- Does it earn its place in the paragraph, or is it floating?
- Does it add something the surrounding text could not carry on its own?

If any of these checks fail, rework or cut it. A quote that does not serve the passage is worse than no quote at all.
