  ...
  return (
    <div className="mt-4 border-t border-stone-200 pt-4 dark:border-stone-700">
      <div className="mb-2 flex items-center gap-2">
        ...
        <span className="font-ui text-[10px] font-semibold uppercase tracking-wider text-stone-500">Instruct the editor</span>
      </div>
      <textarea
        ref={taRef}
        value={text}
      ...
      {history.length > 0 && (
        <div className="mt-3 space-y-1.5">
          <div className="font-ui text-[9px] font-semibold uppercase tracking-wider text-stone-400">Recent</div>
          {history.map((h) => (
