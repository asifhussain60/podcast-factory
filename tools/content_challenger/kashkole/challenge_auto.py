...
review and writes kashkole-challenger-report.md.
...
CHALLENGE_COST_LEDGER = REPO_ROOT / "_workspace" / "plan" / "kashkole-challenge-cost-ledger.jsonl"
...
def challenge_bundle(
    ...
    *,
    ...
    report_file = text_dir / "kashkole-challenger-report.md"
