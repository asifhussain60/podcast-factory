...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        "generate at the Default length. Shorter cannot hold a long list: run 1 gave 39 terms\n"
        "five minutes and the model named 9. To probe fewer, pass --top-n; settled terms\n"
        "drop out of the next run, so a short list is a batch rather than a compromise.\n"
