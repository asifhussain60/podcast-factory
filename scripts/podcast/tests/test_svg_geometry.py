...
from _svg_geometry import auto_expand_viewbox, geometry_findings
...
def test_negative_viewbox_origin_is_respected():
    ...
    svg = _svg('<text x="-40" y="40" font-size="14">Edge label</text>', viewbox="-60 0 560 300")
...
def test_min_type_flagged_on_wide_viewbox():
    svg = _svg('<text x="100" y="40" font-size="9">tiny label</text>', viewbox="0 0 1400 700")
