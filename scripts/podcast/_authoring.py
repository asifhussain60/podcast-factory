...
def author_framing(book_dir: Path, chapter_slug: str,
    ...
    prompt = (
        ...
        f"`scripts/podcast/_rules.py::MODERNIZE_DENY` — e.g. avoid 'deep dive' / 'deep-dive' "
        f"in any descriptive metadata. Use 'in-depth conversation' or 'long-form "
        f"discussion' instead. The deny-block scan does not distinguish content from "
        f"metadata.\n"
