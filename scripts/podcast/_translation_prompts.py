...
- A Quran verse, hadith, or quoted saying gets its Arabic ONCE, in its own quoted block, never twice. Write the block-quoted Arabic, then underneath it a CLEAN English translation in plain American English with NO Arabic words or phrases mixed into that translation sentence. Do not repeat a fragment of the Arabic inside the English rendering — "The truthful merchant is raised with the truthful and the martyrs" is correct; "The truthful merchant — اَلتَّاجِرُ الصَّدُوقُ — is raised... with الصِّدِّيقِينَ" is wrong, because it prints the same words in script twice on the page and breaks the English sentence in half. This does not apply to a standalone glossary term the book is teaching (that stays a single parenthetical, per house style) — it applies specifically to translating a quoted verse or saying.
