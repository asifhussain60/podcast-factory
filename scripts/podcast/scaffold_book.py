...
- Creates: chapters/, chapter-contracts/, episodes/, turboscribe/, _system/{,
...
- Writes a starter _README.md and turboscribe/_README.md.
...
TURBOSCRIBE_README_TEMPLATE = """# TurboScribe transcripts
...
NotebookLM renders the Audio Overview from the chapter + customize prompt. Transcribe the audio via TurboScribe (https://turboscribe.ai) and drop the result here, renamed to the slug-aligned form. Nothing in the pipeline writes to this folder — human input only.
...
def scaffold(category: str, book_slug: str, title: str, author: str | None, force: bool) -> int:
    ...
    files = [
        ...
        (book_dir / "turboscribe" / "_README.md", TURBOSCRIBE_README_TEMPLATE.format(**bindings)),
