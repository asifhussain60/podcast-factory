...
Usage:
    python scripts/kashkole/kashkole_translate_all.py
    python scripts/kashkole/kashkole_translate_all.py --dry-run
    python scripts/kashkole/kashkole_translate_all.py --binder 35
"""
