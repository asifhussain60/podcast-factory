...
Usage:
    python scripts/kashkole/kashkole_adapt_all.py
    python scripts/kashkole/kashkole_adapt_all.py --dry-run
    python scripts/kashkole/kashkole_adapt_all.py --binder 35
"""
...
def _adapt_chapter(binder_id: int, chapter_id: int, dry_run: bool) -> float:
    ...
    result = subprocess.run(cmd, capture_output=True, text=True, cwd=REPO, timeout=None)
