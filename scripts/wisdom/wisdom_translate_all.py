...
Usage:
    python scripts/wisdom/wisdom_translate_all.py
...
LEDGER = REPO / "_workspace/plan/wisdom-translation-cost-ledger.jsonl"
...
def _translate_chapter(binder_id: int, chapter_id: int, dry_run: bool) -> float:
    ...
    if dry_run:
        cmd.append("--dry-run")
    cmd += ["wisdom", "--binder", str(binder_id), "--chapter", str(chapter_id)]
