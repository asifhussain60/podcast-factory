...
Usage:
  python scripts/wisdom/binder_driver.py survey BINDER_ID
  python scripts/wisdom/binder_driver.py prepare BINDER_ID
  python scripts/wisdom/binder_driver.py vision-list BINDER_ID
  python scripts/wisdom/binder_driver.py finalize-review-seal BINDER_ID
