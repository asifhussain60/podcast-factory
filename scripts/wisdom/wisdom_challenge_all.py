...
Usage:
    python scripts/wisdom/wisdom_challenge_all.py
    python scripts/wisdom/wisdom_challenge_all.py --dry-run
...
LEDGER = REPO / "_workspace/plan/wisdom-challenge-cost-ledger.jsonl"
FAILURE_LOG = REPO / "_workspace/plan/wisdom-challenge-failures.log"
FAIL_REPORT = REPO / "_workspace/plan/wisdom-challenge-fail-report.md"
