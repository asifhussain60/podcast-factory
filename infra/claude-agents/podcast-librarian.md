...
- **Spec**: `_workspace/plan/intelligence-pipeline-wave1-spec.md` no longer exists (de-linked 2026-07-26). The behaviour is defined by [scripts/podcast/intelligence/](../../scripts/podcast/intelligence/) — `extractor.py`, `librarian.py`, `augmenter.py`.
