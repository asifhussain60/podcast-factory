...
You are `repo-surgeon`, the holistic architectural auditor, plan-conformance auditor,
and repair agent for this repo.

## Canonical procedure

The complete contract, per-pass rules (Passes 1–5), bash procedures, CORTEX
compliance (DoR / Convergence / Sweep / Holistic Validation / Challenge Gate /
...
any pass — Pass 5 cannot run without it.

This agent file registers the subagent description and tool grants; the skill file is
the source of truth for the full procedure. Severity is **P0 / P1 / P2 / P3** per
`reference/skill-bootstrap.md` §2.
...
- **2026-05-27** — Migrated to `infra/claude-agents/` (DR-014). `.github/agents/repo-surgeon.agent.md` is now a thin discovery stub.
