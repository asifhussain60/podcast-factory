...
1. N3-a — Add Pronounce directive for `Al-hayula` to [EP10 framing](../../content/podcast/library/books/kitab-al-riyad/_system/episode-drafts/EP10-motion-stillness-hyle-and-form/00-framing.md)
2. N3-b — Add Pronounce directive for `Al-nafs` to same framing
3. A4 — Fix Q16:40 translator attribution (Pickthall → Yusuf Ali) in [ch10 chapter](../../content/podcast/library/books/kitab-al-riyad/chapters/ch10-motion-stillness-hyle-and-form.txt)
After fixes: run `python3 scripts/podcast/build_episode_txt.py content/podcast/library/books/kitab-al-riyad EP10-motion-stillness-hyle-and-form` to re-emit the episode .txt. Then re-run the challenger to confirm P0=0/P1=0 (or just N3-a/N3-b/A4 cleared).
...
3. Run `python3 scripts/podcast/build_episode_txt.py content/podcast/library/books/kitab-al-riyad EP##-<slug>` to emit episode .txt.
...
python3 scripts/podcast/build_episode_txt.py \
    content/podcast/library/books/kitab-al-riyad \
