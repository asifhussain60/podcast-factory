...
**Full context document:** `_workspace/kashkole-brief.md` — read §18 first, then §§1–12 for corpus detail.
...
_workspace/kashkole-brief.md  ← full context document (read §18)
```
