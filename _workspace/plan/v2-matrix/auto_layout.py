...
out.write_text(
    json.dumps({"schema": "book.visual-layout/v1", "placements": placements}, indent=2, ensure_ascii=False) + "\n",
    encoding="utf-8",
)
print(
    f"auto-layout: {len(placements)} placement(s) ({resolved} snippet-resolved, "
