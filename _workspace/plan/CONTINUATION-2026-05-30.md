...
| ⬜ | 2-fix | **Retrofix:** Arabic terminus technicus stripped during denoise/normalize (tawil→"esoteric interpretation" etc.). Fix gemini_refine.py prompts (add TERMINUS TECHNICUS guard + glossary protect-list); add SN-7 to house-voice standard; re-run denoise+normalize for all 5 chapters. ~$0.07. Must land before Slice 7. | Gemini | ~$0.07 | — |
