...
| DR-013 | **Retroactive enhancements for shipped books = addendum-only** | Never re-run the pipeline against KaR, M&D, Ayyuhal Walad, etc. New episodes ship as addenda. Scope clarified 2026-07-16 (Asif): this protects the PODCAST surfaces (episodes/audio/chapters); `0book-*` reading-edition re-runs on the book's own content branch are exempt. | 2026-05-26 |
