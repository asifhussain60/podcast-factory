...
# Minimal Urdu/Arabic word stem map. Extend over time; unknown words fall
# through to a deterministic transliteration of the first 2-3 syllables.
URDU_STEM_MAP = {
...
def slugify_urdu(text: str, db_id: int, max_len: int = 40) -> str:
    ...
    for w in words:
        ...
        if mapped:
            ...
            # Fall through: produce a 4-char fingerprint from the unmapped word
