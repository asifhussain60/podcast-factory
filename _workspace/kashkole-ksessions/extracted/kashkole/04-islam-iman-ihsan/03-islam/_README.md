...
| Source language | `ur` |
| Binder (shelf) | ISLAM IMAN IHSAN (id 36, sort_key 1) |
| Chapter (this book) | id 175, sort_key 3 |
| Topics (sections) | 19 (19 with content) |
| Inline images | 36 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/islam.html` — audit anchor (concatenated raw HTML; never modified)
