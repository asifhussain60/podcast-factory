...
| Source language | `ur` |
| Binder (shelf) | آداب و اخلاق حسنۃ (id 27, sort_key 2) |
| Chapter (this book) | id 17, sort_key 3 |
| Topics (sections) | 13 (13 with content) |
| Inline images | 15 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/wilayat-se-x7982-mazameen.html` — audit anchor (concatenated raw HTML; never modified)
