...
| Chapter (this book) | id 18, sort_key 8 |
| Topics (sections) | 34 (34 with content) |
| Inline images | 121 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/qurani-ayaat-ki-taweel.html` — audit anchor (concatenated raw HTML; never modified)
