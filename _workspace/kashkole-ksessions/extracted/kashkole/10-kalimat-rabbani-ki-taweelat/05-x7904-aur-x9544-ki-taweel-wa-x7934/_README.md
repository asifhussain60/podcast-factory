...
| Chapter (this book) | id 25, sort_key 5 |
| Topics (sections) | 26 (26 with content) |
| Inline images | 77 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x7904-aur-x9544-ki-taweel-wa-x7934.html` — audit anchor (concatenated raw HTML; never modified)
