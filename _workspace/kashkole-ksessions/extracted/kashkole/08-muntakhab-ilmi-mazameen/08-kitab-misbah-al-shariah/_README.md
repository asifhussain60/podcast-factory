...
| Chapter (this book) | id 38, sort_key 8 |
| Topics (sections) | 98 (16 with content) |
| Inline images | 14 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/kitab-misbah-al-shariah.html` — audit anchor (concatenated raw HTML; never modified)
