...
| Source language | `ur` |
| Binder (shelf) | قرآنی قصص الانبیا کے حقائق (id 18, sort_key 8) |
| Chapter (this book) | id 52, sort_key 3 |
| Topics (sections) | 18 (17 with content) |
| Inline images | 0 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x6334-x4758-alayhi-as-salam.html` — audit anchor (concatenated raw HTML; never modified)
