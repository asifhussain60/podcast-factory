...
| Chapter (this book) | id 159, sort_key 14 |
| Topics (sections) | 6 (6 with content) |
| Inline images | 1 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/misconceptions-arguments.html` — audit anchor (concatenated raw HTML; never modified)
