...
| Source language | `ur` |
| Binder (shelf) | The Wise Reminder (id 35, sort_key 1) |
| Chapter (this book) | id 177, sort_key 2 |
...
- `_system/source/the-human-spirit.html` — audit anchor (concatenated raw HTML; never modified)
