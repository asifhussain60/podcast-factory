...
| Chapter (this book) | id 96, sort_key 4 |
| Topics (sections) | 3 (3 with content) |
| Inline images | 3 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x6372-ke-x7938.html` — audit anchor (concatenated raw HTML; never modified)
