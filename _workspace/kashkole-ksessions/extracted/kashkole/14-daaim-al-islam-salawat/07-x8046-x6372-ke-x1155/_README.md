...
| Chapter (this book) | id 99, sort_key 7 |
| Topics (sections) | 16 (16 with content) |
| Inline images | 5 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x8046-x6372-ke-x1155.html` — audit anchor (concatenated raw HTML; never modified)
