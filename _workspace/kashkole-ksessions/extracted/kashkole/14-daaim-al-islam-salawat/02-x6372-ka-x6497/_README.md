...
| Chapter (this book) | id 94, sort_key 2 |
| Topics (sections) | 10 (10 with content) |
| Inline images | 14 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x6372-ka-x6497.html` — audit anchor (concatenated raw HTML; never modified)
