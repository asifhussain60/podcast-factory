...
| Source language | `ur` |
| Binder (shelf) | دعائم الاسلام : صلواۃ (id 26, sort_key 11) |
| Chapter (this book) | id 98, sort_key 6 |
| Topics (sections) | 20 (20 with content) |
| Inline images | 5 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x6372-ki-x8036-ke-x1155.html` — audit anchor (concatenated raw HTML; never modified)
