...
| Chapter (this book) | id 121, sort_key 5 |
| Topics (sections) | 18 (18 with content) |
| Inline images | 4 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/tawheed-ka-x6360.html` — audit anchor (concatenated raw HTML; never modified)
