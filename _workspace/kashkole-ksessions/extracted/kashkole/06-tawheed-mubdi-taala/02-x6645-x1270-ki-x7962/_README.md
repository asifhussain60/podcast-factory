...
| Chapter (this book) | id 2, sort_key 2 |
| Topics (sections) | 9 (9 with content) |
| Inline images | 2 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x6645-x1270-ki-x7962.html` — audit anchor (concatenated raw HTML; never modified)
