...
| Chapter (this book) | id 81, sort_key 9 |
| Topics (sections) | 8 (8 with content) |
| Inline images | 2 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/nufoos-aur-in-ki-aqsam.html` — audit anchor (concatenated raw HTML; never modified)
