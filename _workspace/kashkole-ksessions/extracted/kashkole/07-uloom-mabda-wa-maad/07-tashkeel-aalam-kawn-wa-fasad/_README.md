...
| Source language | `ur` |
| Binder (shelf) | علوم مبدا و معاد (id 1, sort_key 4) |
| Chapter (this book) | id 80, sort_key 7 |
...
- `_system/source/tashkeel-aalam-kawn-wa-fasad.html` — audit anchor (concatenated raw HTML; never modified)
