...
| Chapter (this book) | id 21, sort_key 12 |
| Topics (sections) | 39 (38 with content) |
| Inline images | 42 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/maratib-aur-majame.html` — audit anchor (concatenated raw HTML; never modified)
