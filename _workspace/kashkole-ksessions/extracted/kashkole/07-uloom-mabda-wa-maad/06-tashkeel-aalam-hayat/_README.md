...
| Chapter (this book) | id 78, sort_key 6 |
| Topics (sections) | 7 (7 with content) |
| Inline images | 3 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/tashkeel-aalam-hayat.html` — audit anchor (concatenated raw HTML; never modified)
