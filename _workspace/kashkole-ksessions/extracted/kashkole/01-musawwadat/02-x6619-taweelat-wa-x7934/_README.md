...
| Chapter (this book) | id 117, sort_key 1 |
| Topics (sections) | 4 (4 with content) |
| Inline images | 1 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x6619-taweelat-wa-x7934.html` — audit anchor (concatenated raw HTML; never modified)
