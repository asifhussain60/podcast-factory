...
| Source language | `ur` |
| Binder (shelf) | مسودے (id 28, sort_key 0) |
| Chapter (this book) | id 150, sort_key 8 |
| Topics (sections) | 11 (10 with content) |
| Inline images | 1 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/sunday-sessions-breakups.html` — audit anchor (concatenated raw HTML; never modified)
