...
| Chapter (this book) | id 37, sort_key 7 |
| Topics (sections) | 19 (18 with content) |
| Inline images | 1 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x3212-x4894-x7939-x3180-x7926-x8263.html` — audit anchor (concatenated raw HTML; never modified)
