...
| Chapter (this book) | id 141, sort_key 6 |
| Topics (sections) | 25 (25 with content) |
| Inline images | 3 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/khutba-kumayl-ka-x8213.html` — audit anchor (concatenated raw HTML; never modified)
