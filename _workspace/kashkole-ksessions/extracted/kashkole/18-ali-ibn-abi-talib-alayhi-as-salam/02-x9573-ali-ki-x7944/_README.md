...
| Chapter (this book) | id 46, sort_key 2 |
| Topics (sections) | 21 (21 with content) |
| Inline images | 36 |

## Layout

- `bundle.yml` — manifest read by intake (slug, source_language, sections list)
- `_system/source/x9573-ali-ki-x7944.html` — audit anchor (concatenated raw HTML; never modified)
