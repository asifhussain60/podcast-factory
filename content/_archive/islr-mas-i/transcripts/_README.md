...
Slug-aligned transcripts for *An Introduction to Statistical Learning (ISL2) — MAS-I Subset*. One file per episode, named `EP##-<slug>.transcript.txt` to match `chapters/ch##-<slug>.txt` and `episodes/EP##-<slug>.txt` exactly.
