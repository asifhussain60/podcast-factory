...
- P0 hits (architecture failures): **22**
- P1 hits (drift signals): **33**
...
|---|---|---|
| `Ayyuhal Walad` | `i you hall wall odd` | 1 |
| `Tasawwuf` | `tassel wolf` | 1 |
| `Tasawwuf` | `tasa wolf` | 5 |
| `Ikhlas` | `aclus` | 2 |
| `Ikhlas` | `iclas` | 1 |
| `Dhul-Nun al-Misri` | `shakestone noon mystery` | 1 |
| `Bay'a` | `bhaya` | 1 |
| `Riyazat` | `rizat` | 1 |
| `Mujahadah` | `mujahada` | 1 |
| `Riya` | ` rhea ` | 3 |
| `Sahih Bukhari` | `sahail bukhari` | 1 |
| `Sahih Muslim` | `sahi muslim` | 1 |

## Welcome-opening violations · R-WELCOME (P0)

**None detected.**

## Modernization injections · R-NOMODERNIZE (P1) · density 2.3 per 1k words
...
## Surprise-noise loops · R-NOSURPRISE (P1) · density 7.1 per 1k words
...
## Filler interjections · R-NOINTERRUPT (P2) · density 4.3 per 1k words
