...
Series: **Ayyuhal Walad** (Imam Abu Hamid Muhammad al-Ghazali, English translation by Irfan Hasan from the Urdu rendering of the Arabic original).
Source: `ayyuhal-walad/_system/source/text/` (cleaned source + phonetics index; verbatim PDF at `ayyuhal-walad/_system/source/Ayyuhal-Walad.pdf`).
Segmentation: 5 episodes covering the 30-page epistle, re-segmented thematically (not by translator section breaks). See `ayyuhal-walad/_system/source/text/chapters-rationale.md` for grouping logic.
