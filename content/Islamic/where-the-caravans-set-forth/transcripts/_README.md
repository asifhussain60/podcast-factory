...
Slug-aligned transcripts for *Where the Caravans Set Forth*. One file per episode, named `EP##-<slug>.transcript.txt` to match `chapters/ch##-<slug>.txt` and `episodes/EP##-<slug>.txt` exactly.
