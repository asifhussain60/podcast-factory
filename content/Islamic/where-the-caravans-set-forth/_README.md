# Podcast — Where the Caravans Set Forth

**Source:** *Where the Caravans Set Forth*.

**Slug:** `where-the-caravans-set-forth` · **Category:** `books` · **Architecture:** v3.5 (chapter-as-source; phonetics in customize prompt only).
