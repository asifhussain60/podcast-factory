# Podcast — Degrees of Excellence

**Source:** *Degrees of Excellence* by Ahmad b. Ibrahim al-Naysaburi.

**Slug:** `degrees-of-excellence` · **Category:** `books` · **Architecture:** v3.5 (chapter-as-source; phonetics in customize prompt only).
