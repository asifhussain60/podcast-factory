# Enrichment Whitelist — Degrees of Excellence (Tier 1, book-specific)

Per the enrichment tier policy carried in [scripts/podcast/_authoring.py](../scripts/podcast/_authoring.py) Phase 0e prompt (formerly `content/podcast/.skill/handbook/enrichment-sources.md` §1, retired 2026-05-23), Tier 1 is the **author's own corpus**, scoped per book. Enumerate al-Naysaburi's corpus here; citations from these works are highest-priority enrichment for any chapter in this book.
