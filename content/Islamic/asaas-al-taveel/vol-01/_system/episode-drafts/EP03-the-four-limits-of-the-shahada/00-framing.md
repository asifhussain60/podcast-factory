...
Thoughtful adult readers who have heard al-Nu'man establish (in the previous chapter) that the shahada from its very first utterance already contained the whole sacred law, and who are now ready to be shown what is actually inside it. They are listening for the structural diagram of the book: the four limits the testimony names, the seven Speaker-Prophets it organizes, the twelve successors it arranges, and how the upper world (Pen, Tablet) and the lower world (Speaker, Silent One) are paired through the syntax of "There is no god but Allah."
...
The hosts must NOT do the following:
  ...
  - Walk al-Nu'man in the order he actually walks. Syntax of the shahada
