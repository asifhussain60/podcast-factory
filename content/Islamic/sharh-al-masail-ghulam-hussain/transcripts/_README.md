...
Slug-aligned transcripts for *Sharh al-Masa'il — Sayyidna Ghulam Hussain*. One file per episode, named `EP##-<slug>.transcript.txt` to match `chapters/ch##-<slug>.txt` and `episodes/EP##-<slug>.txt` exactly.
