...
2. Upload `content/podcast/library/books/ayyuhal-walad/chapters/ch04-four-cautions.txt` as the single source for the notebook.
3. Paste the contents of `content/podcast/library/books/ayyuhal-walad/episodes/EP04-four-cautions.txt` into NotebookLM's *Customize* prompt box.
